<div class="modal fade" id="addSatuanProduk" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content p-md-5 p-3">
            <div class="modal-body p-md-0">
                ...
                <div class="mb-4 text-center">
                    <h3 class="address-title mb-2 pb-1">Tambah / Edit Satuan Produk</h3>
                ...
                <form id="addNewAddressForm" class="row g-4 form-save" onsubmit="return false">
                    <input type="hidden" value="{{ $data ? $data->id_master_satuan : null }}" name="id">
                    <div class="col-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="kode_produk" name="kode_produk"
                                value="{{ $data ? $data->kode_satuan : null }}" class="form-control"
                                placeholder="Kode Produk" />
                            <label for="kode_produk">Kode Satuan *</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="satuan_produk" name="satuan_produk"
                                value="{{ $data ? $data->nama_satuan : null }}"class="form-control"
                                placeholder="Satuan Produk" />
                            <label for="satuan_produk">Nama Satuan *</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-floating form-floating-outline">
                            <input type="number" id="jumlah_pieces" name="jumlah_pieces"
                                value="{{ $data ? $data->jumlah_pieces : null }}" class="form-control"
                                placeholder="Nama" />
                            <label for="jumlah_pieces">Jumlah Pieces dalam Satuan * </label>
                        </div>
                    </div>
    ...
    $('.btn-submit').click(function(e) {
        ...
        $.ajax({
            ...
            if (data.status == 'success') {
                ...
                $('#addSatuanProduk').modal('hide'); // Show the modal
                $('.main-page').show();
